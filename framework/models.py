...
'''
this script contains classes for 2 models: first: Resnet50x1 used to load the pretrained weights from here 
https://github.com/google-research/simclr; second: Resnet18 used for training on data from scratch
'''
...
def GetModel(model_name): # either 'Resnet50' or 'Resnet18' 
